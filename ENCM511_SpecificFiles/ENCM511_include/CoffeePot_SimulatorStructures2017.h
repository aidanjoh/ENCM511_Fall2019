...
#define COFFEEPOT_INSERTED   (1 << 11)		// BIT 11 -> 0x1000

// If you change anything in this structure -- then your project no longer matches my simulator and will not work
