...
void My_Init_GPIO_REB_InputCpp(void)
{
		...
		*pREG_PORTF_DATA = 0x0000; //Setting the port F data register to all 0's to begin with
		...
		*pREG_PORTF_POL = 0x0000; //Setting the port F polarity register to all 0's to begin with
